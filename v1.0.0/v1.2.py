...
try:
    ...
    def get_time_to_end():
        ...
        text_numbers = driver.find_element(By.XPATH,
                                           "//p[@class='text-Wu2pIo3E small-Wu2pIo3E']/span[2]").text
    ...
    def generate_45():
        ...
        return [round_to_nearest_5_minutes(start_time - timedelta(minutes=45 * i)) for i in range(32)]
    ...
    def market_closed():
        ...
        text_numbers = driver.find_element(By.XPATH,
                                           '/html/body/div[5]/div[2]/span/div[1]/div/div/div[1]/div/p/span[2]').text
    ...
    def time_to_next_45_minutes():
        ...
        for time in reversed(times):
            if now < time:
                ...
                a = remaining_time.seconds // 60, remaining_time.seconds % 60
                print(a)
                return a
...
try:
    def save_last_candle():
        ...
        try:
            ...
            # Signal
            if last_price:
                if last_price['Position'] == 'R' and new_price['Position'] == 'G' and last_price['Low'] > new_price[
                    'Low']:
